...
<div id="content">
  ...
  <div class="container-fluid">
    <h1 class="h3 mb-4 text-gray-800 font-weight-bold">Edit Obat</h1>
    ...
    <div class="card shadow mb-4">
      <div class="card-header py-3">
        <h5 class="font-weight-bold text-primary">Form Edit Obat</h5>
      </div>
      <div class="card-body">
        <form method="POST" action="{{ route('obat.update', $obat->id) }}">
          ...
          <div class="form-group">
            ...
            <input type="text" name="nama_obat" id="nama_obat" class="form-control @error('nama_obat') is-invalid @enderror"
              value="{{ old('nama_obat', $obat->nama_obat) }}" placeholder="Contoh: Paracetamol">
            @error('nama_obat')
          ...
          <div class="form-group">
            ...
            <input type="text" name="jenis" id="jenis" class="form-control @error('jenis') is-invalid @enderror"
              value="{{ old('jenis', $obat->jenis) }}" placeholder="Contoh: Tablet, Kapsul, Sirup">
            @error('jenis')
              <span class="invalid-feedback"><strong>{{ $message }}</strong></span>
            @enderror
          </div>
          ...
          <div class="form-group">
            ...
            <input type="text" name="dosis" id="dosis" class="form-control @error('dosis') is-invalid @enderror"
              value="{{ old('dosis', $obat->dosis) }}" placeholder="Contoh: 500mg, 10ml">
            @error('dosis')
              <span class="invalid-feedback"><strong>{{ $message }}</strong></span>
            @enderror
          </div>
          ...
          <div class="form-group">
            ...
            <input type="number" name="stok" id="stok" class="form-control @error('stok') is-invalid @enderror"
              value="{{ old('stok', $obat->stok) }}" placeholder="Contoh: 100">
            @error('stok')
              <span class="invalid-feedback"><strong>{{ $message }}</strong></span>
            @enderror
          </div>
          ...
          <div class="form-group">
            ...
            <input type="text" name="satuan" id="satuan" class="form-control @error('satuan') is-invalid @enderror"
              value="{{ old('satuan', $obat->satuan) }}" placeholder="Contoh: Tablet, Botol">
            @error('satuan')
              <span class="invalid-feedback"><strong>{{ $message }}</strong></span>
            @enderror
          </div>
          ...
          <div class="form-group">
            ...
            <input type="number" name="harga" id="harga" class="form-control @error('harga') is-invalid @enderror"
              value="{{ old('harga', $obat->harga) }}" placeholder="Contoh: 10000">
            @error('harga')
              <span class="invalid-feedback"><strong>{{ $message }}</strong></span>
            @enderror
          </div>
