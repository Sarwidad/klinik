...
<div id="content">
  ...
  <div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800 font-weight-bold">Tambah Pasien</h1>
    ...
    <div class="card shadow mb-4">
      <div class="card-header py-3">
        <h5 class="font-weight-bold text-primary">Masukkan Data Pasien</h5>
      </div>
      <div class="card-body">
        <form method="POST" action="{{ route('pasien.store') }}" enctype="multipart/form-data">
          ...
          <button type="submit" class="btn btn-info">Tambah Pasien</button>
