...
<div id="content">
  ...
  <div class="container-fluid">
    <h1 class="h3 mb-4 text-gray-800 font-weight-bold">{{ isset($rekamMedis) ? 'Edit' : 'Tambah' }} Rekam Medis</h1>
    ...
    <div class="card shadow mb-4">
      <div class="card-header py-3">
        <h5 class="font-weight-bold text-primary">Form Rekam Medis</h5>
      </div>
      <div class="card-body">
        <form method="POST" action="{{ isset($rekamMedis) ? route('rekam_medis.update', $rekamMedis->id) : route('rekam_medis.store') }}">
          @csrf
          @if(isset($rekamMedis))
            @method('PUT')
          @endif
          ...
          <button type="submit" class="btn btn-success">{{ isset($rekamMedis) ? 'Update' : 'Simpan' }}</button>
